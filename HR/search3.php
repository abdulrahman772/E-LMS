...
if ($do == 'search') {
  ...
  <div class="row">
      <form class="text-center" style=" margin:0; padding:50px 0 0 0; width:100%;" action="search3.php?do=search" method="POST" enctype="multipart/form-data">
...
if ($stmt->rowCount() > 0) {
     $Emp_id =$row['Emp_id'];
      $sstatus = 1 ;
      $stmt = $con->prepare("SELECT * FROM transactions WHERE  Emp_id =?LIMIT 9 ");
